...
export default function SortProductByPrice({
  ...
  const relevanceColor = isRelevanceActive
  ...
  return (
    <div className={`relative ${cn(className)}`} onClick={handleRelevanceSort}>
      <div
        className={`flex w-full cursor-pointer items-center justify-between rounded-lg border-black ${cn(relevanceColor)} px-2 py-[5px]`}
      >
